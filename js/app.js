        ...
        const toggle = function() {
          ...
          if (startDiv.style.display === 'block' || startDiv.style.display === '') {
        ...
        const PUZZLE_HOVER_TINT = '#204857';
        ...
        function init(){
            ...
            _img.src = "http://lorempixel.com/900/600/nature";
        }
        ...
        function setCanvas(){
            ...
            _canvas.style.border = "2px solid #FFE6E6";
        }
        ...
        function addElement() {
          ...
          congrBox.className +=  "congrBox";
          const congrTextBox = document.createElement("div");
          const newContent = document.createTextNode('Congratulations!');
          congrTextBox.appendChild(newContent);
          congrTextBox.className += "congrTextBox";
